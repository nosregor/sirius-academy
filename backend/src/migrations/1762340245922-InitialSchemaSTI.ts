...
/**
 * Initial schema migration with Single Table Inheritance
 *
 * Creates:
 ...
 * - Indexes on deletedAt, type discriminator, and relationships
 *
 * Features:
 ...
 */
export class InitialSchemaSTI1762340245922 implements MigrationInterface {
  name = 'InitialSchemaSTI1762340245922';

  public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('teacher', 'student')`);
        await queryRunner.query(`CREATE TYPE "public"."users_type_enum" AS ENUM('teacher', 'student')`);
        ...
        await queryRunner.query(`ALTER TABLE "lessons" ADD CONSTRAINT "FK_91eb3280b50fe17091b191bbd98" FOREIGN KEY ("teacher_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lessons" ADD CONSTRAINT "FK_3bc5bfec4b380597fc4e0042e1b" FOREIGN KEY ("student_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "teacher_students" ADD CONSTRAINT "FK_328c82890a2e85fca6e82f49a5c" FOREIGN KEY ("teacher_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "teacher_students" ADD CONSTRAINT "FK_8378666b935ffb8f64262580fc4" FOREIGN KEY ("student_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
